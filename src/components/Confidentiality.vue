		...
		<div class="m-4 p-4">
			<div>
				...
				<p>
					...
					de suivi et historicisation de connexion. Toutefois, vous
					pouvez choisir de communiquer des données personnelles
					sur le domaine www.aubergedepeillon.fr, au sein de la page
					«&nbsp;Contact&nbsp;», via le formulaire.
				</p>
				<p>
					Ces données personnelles collectées sur le site www.aubergedepeillon.fr
				...
				<p>
					Ces sites web pourraient collecter des données sur
			...
			<div>
				...
				<div>
					...
					<p>
						Vos données à caractère personnel ne seront pas
						conservées au-delà de la durée strictement nécessaire à la gestion de notre
						relation avec vous. Elles seront effacées, en tout état de cause, au maximum 6 (six) mois après la fin de cette relation.
					</p>
					<p>
						Toutefois, les données permettant d’établir la preuve
						d’un droit, d’un lien ou d’un contrat, devant être conservées au titre du
						respect d’une obligation légale, le seront pendant la durée prévue par la loi en vigueur.&nbsp;
					</p>
				</div>
				<div>
					<h3>Les droits que vous avez sur vos données</h3>
					<p>
						Si vous avez contacté «&nbsp;L'auberge de Peillon&nbsp;»
						par&nbsp;le formulaire de contact présent sur le site, vous pouvez demander à
					...
					<p>
						Il est rappelé que toute personne peut, pour des
						motifs légitimes, demander la limitation au traitement des données la
						concernant (article 18 du RGPD) ou s’opposer audit traitement (articles 21 et 22 du RGPD).
					</p>
					<p>
						Pour toute demande relative à vos données personnelles, nous vous invitons à nous contacter à l’adresse suivante&nbsp;:
						<a href="mailto:gestiondonnees@aubergedepeillon.fr">gestiondonnees@aubergedepeillon.fr</a>
					</p>
				</div>
			</div>
		</div>
