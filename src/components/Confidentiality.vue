		...
		<div class="m-4">
			<div>
				...
				<p>De manière générale, vous n’êtes pas tenu de nous
					...
					«&nbsp;Contact&nbsp;», via le formulaire.</p>
				<p>Ces données personnelles collectées sur le site www.aubergedepeillon.fr
				...
				<p>Vos données personnelles seront conservées
					...
					de messagerie électronique et, éventuellement, numéro de téléphone.</p>
			...
			<div>
				...
				<div>
					...
					<p>Si vous avez contacté «&nbsp;L'auberge de Peillon&nbsp;»
							...
							légales ou pour des raisons de sécurité.</p>
					<p>Conformément à la loi n° 78-17 du 6 janvier 1978
							...
							l’effacement (articles 16 et 17 du RGPD).</p>
					...
					<p>Pour toute demande relative à vos données personnelles, nous vous
							invitons à nous contacter à l’adresse suivante&nbsp;: <a href="mailto:gestiondonnees@aubergedepeillon.fr">gestiondonnees@aubergedepeillon.fr</a></p>
				</div>
			</div>
		</div>
    </div>
